                        ...
                        <div  class="col-md-6 overflow-auto dewl-flex">
                            ...
                            <div class="container dewl-content text-center">
                                ...
                                <div class="row dewl-row">
                                    <div class="col-md-3 vs-div" > {{--       el icono vrs entrara en un if cuando se cambie el color                 --}}
                                        {{ HTML::image('img/Dewlers_iconos_VS.svg', '303', array('style' => 'width: 33px; high: 33px;')) }}
                                    </div>
