    ...
    <div class="col-lg-12 duelwitness text-center">
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <form action="/send_rev" method="post" id="witnees_review{{$id}}">
                    @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="text-center underline" style="margin-top: 30px; ">
                                ...
                                <div class="text-center">
                                    <textarea id="txtarea" name="review" class="textareastyle" rows="10" style="margin-top:5px; max-width:50%; width:570px;"></textarea>
                                </div>
