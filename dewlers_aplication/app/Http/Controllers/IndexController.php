...
//-------------------------------------------------------------*------------------------------------------------------------*------------------------------------
        ...
        $record_loser=duels::with('ctlUser0','ctlUser3', 'duelstatus')->where([['ctl_user_id_winner','!=',$id_auth->id],['duelstate','=',6],['ctl_user_id_witness','!=',$id_auth->id],['ctl_user_id_challenger','=',$id_auth->id]])->orWhere([['ctl_user_id_winner','!=',$id_auth->id],['duelstate','=',6],['ctl_user_id_witness','!=',$id_auth->id],['ctl_user_id_challenger','=',$id_auth->id]])->get();
